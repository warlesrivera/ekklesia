                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar  static-top shadow col-md-10 col-12" style="position: fixed;
                z-index: 100">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" onclick="initQr('{{url('readMeeting')}}','Home')" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" title="Leer Qr" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{route('usuarios.show',$friend->sender->id)}}">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">{{$friend->created_at}}</div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{isset(Auth()->user()->avatar)?asset('storage/img/users/').'/'.Auth()->user()->avatar:asset('assets/images/avatar.png')}}">
                            </a>
